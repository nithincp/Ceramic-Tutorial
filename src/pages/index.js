            ...
            <div className={styles.mt2}>
                { record.content ? (
                    <div className={styles.flexCol}>
                        ...
                        <span>The above name was loaded from Ceramic Network. Try updating it below</span>                        
                    </div>
                ) : (
                    <span>
                        You do not have a profile attached to your 3ID. Create
                        a basic profile by setting a new name below.
                    </span>
                )}
            </div>
